...
def filter_metadata(df):
    ...
    df = df[(df['analyte_A260A280Ratio'] > 0) | (df['analyte_A260A280Ratio'].isna())]  # Drop strange values / Keep NaN's
    df = df[(df['aliquot_concentration'] < 2) | (df['aliquot_concentration'].isna())]  # Drop strange values / Keep NaN's
